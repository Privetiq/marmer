            ...
            <div class="banner-wrapper">
                ...
                <div class="banner-form">
                    <div class="block block-form">
                        ...
                        <style>#arrow {fill: #fff;stroke: #fff;stroke-width: .1px; fill-rule: evenodd;} .pvb-display-none, .banner-form .calculation {display: none !important;} #form-step-2 {display: none} </style>
                    </div>
                </div>
            </div>
        </section>
